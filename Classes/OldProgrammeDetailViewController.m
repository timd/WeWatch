...
#import "OldProgrammeDetailViewController.h"
#import "Programme.h"
...
@implementation OldProgrammeDetailViewController
...
-(void)viewWillAppear:(BOOL)animated {
    ...
    NSLog(@"Running ProgrammeDetailViewController viewWillAppear");
...
- (void)viewDidLoad
{
    ...
    NSLog(@"Running ProgrammeDetailViewController viewDidLoad");
...
- (void)viewDidUnload
{
    ...
    NSLog(@"Running ProgrammeDetailViewController viewDidUnLoad");
